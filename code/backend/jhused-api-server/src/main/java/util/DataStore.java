...
public final class DataStore {
  ...
  public static List<Post> samplePosts() {
    ...
    samples.add(new Post("0"+" ".repeat(35), "001",
        "Dummy furniture", 30D,
    ...
    samples.add(new Post("1"+" ".repeat(35), "002",
        "Dummy TV", 40D,
    ...
    samples.add(new Post("3"+" ".repeat(35), "003",
        "Dummy bed", 50D,
    ...
    samples.add(new Post("4"+" ".repeat(35), "004",
        "Dummy desk", 29.99D,
    ...
    samples.add(new Post("5"+" ".repeat(35), "005",
        "Dummy lamp", 29.99D,
    ...
    samples.add(new Post("6"+" ".repeat(35), "005",
        "Dummy cup", 29.99D,
    ...
    samples.add(new Post("7"+" ".repeat(35), "005",
        "Dummy car", 29.99D,
