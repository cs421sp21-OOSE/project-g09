...
public class CustomMatchingChecker implements MatchingChecker {
  ...
  static final CustomCsrfTokenGeneratorMatcher CSRF_TOKEN_MATCHER = new CustomCsrfTokenGeneratorMatcher(new DefaultCsrfTokenGenerator());
